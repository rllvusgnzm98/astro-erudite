---
title: 'Tomcat Manager 认证绕过漏洞深度利用：从弱口令爆破到Root权限接管'
description: '本文介绍的渗透测试过程完整复现了通过Tomcat 7.0.88管理后台弱口令部署恶意WAR包获取初始立足点，结合Linux内核漏洞实现本地提权的完整攻击链，涵盖Hydra爆破、Metasploit模块利用、JSP Webshell部署等关键技术环节。'
date: 2025-02-06
tags: ['Pentesting', 'Tomcat', 'CVE-2009-3843', 'Metasploit', 'Privilege Escalation']
image: '../Reset/assets/image-20250207143334163.png'
authors: ['0xd00']
---
